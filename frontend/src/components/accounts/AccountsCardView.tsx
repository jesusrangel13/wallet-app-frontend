      ...
      {accounts.map((account) => {
        ...
        return (
          ...
          >
            ...
            <div className="bg-white dark:bg-card border border-gray-200 dark:border-gray-700 rounded-lg p-4 pl-6 hover:border-gray-300 dark:hover:border-gray-600 transition-colors h-[139px] flex flex-col justify-between">
