...
export function DashboardMonthSelector({
    ...
    return (
        <div className="relative group">
            ...
            <div className="relative flex items-center gap-1 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border border-white/20 dark:border-white/10 shadow-lg rounded-2xl p-1.5">
                <button
                    onClick={prevMonth}
                ...
                <div className="flex flex-col items-center px-4 min-w-[120px]">
                    ...
                    <span className="text-base font-bold text-gray-900 dark:text-white capitalize leading-none">
                ...
                <button
                    ...
                    className={cn(
                        "p-2 rounded-xl hover:bg-primary/10 text-primary transition-colors",
